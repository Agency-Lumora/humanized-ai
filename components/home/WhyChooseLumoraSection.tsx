...
export function WhyChooseLumoraSection() {
  return (
    <section id="client-control" className="border-b border-[#806C5D]/20 bg-[#DCE7EA] py-[clamp(4rem,8vw,6.5rem)]">
      <Container>
        <motion.div initial={{ opacity: 0, y: 24 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true, amount: 0.2 }} transition={{ duration: 0.95, ease: [0.22, 1, 0.36, 1] }} className="grid gap-[clamp(2.5rem,5vw,4rem)] min-[1000px]:grid-cols-[0.9fr_1.1fr] min-[1000px]:items-center">
